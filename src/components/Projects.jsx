...
const Projects = () => {
  ...
  const projects = [
    {
      ...
      description:
        "A comprehensive customer management system built for UK clients with advanced subscription management and billing features.",
      technologies: [
        "React",
        "Redux",
        "Node.js",
    ...
    },
    {
      ...
      description:
        "A modern self-service portal enabling users to manage their accounts, subscriptions, and preferences independently.",
      technologies: [
        "React",
        "TypeScript",
        "Node.js",
    ...
    },
    {
      ...
      description:
        "Enterprise-level sales platform with advanced inventory management and multi-channel integration.",
    ...
    },
    {
      ...
      description:
        "Comprehensive student management system with course enrollment, grade tracking, and communication features.",
    ...
    },
    {
      ...
      description:
        "Scalable API management platform with authentication, rate limiting, and comprehensive monitoring.",
      technologies: [
        "Node.js",
        "Express",
        "MongoDB",
  ...
  return (
    <section
      id="projects"
      className="py-20 bg-gradient-to-br from-dark-900 via-dark-800 to-dark-900 relative overflow-hidden"
    >
      {/* Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-20 w-96 h-96 bg-primary-500/5 rounded-full blur-3xl animate-pulse-slow"></div>
        <div
          className="absolute bottom-20 right-20 w-96 h-96 bg-accent-500/5 rounded-full blur-3xl animate-pulse-slow"
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="glass-card max-w-5xl xl:max-w-6xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-8">
              ...
              {/* Project Image */}
              <div
                className={`h-64 bg-gradient-to-br ${selectedProject.color} rounded-lg mb-6 flex items-center justify-center`}
              >
                <div className="text-white text-center">
                  <svg
